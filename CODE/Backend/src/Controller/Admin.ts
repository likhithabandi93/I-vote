...
router.get('/getparticipant', async(req:Request,res:Response,next:NextFunction)=>{
    try{
...
router.put('/updateparticipant/:id',upload.fields([{ name: 'participant_photo' }, { name: 'party_symbol' }]), async(req:any,res:any,next:NextFunction)=>{
    try{
...
router.delete('/deleteparticipant/:id', async(req:Request,res:Response,next:NextFunction)=>{
    try{
...
router.get('/getcustomer', async(req:Request,res:Response,next:NextFunction)=>{
    try{
